...
<header class="bg-white dark:bg-gray-900 shadow-md border-b border-gray-200 dark:border-gray-700">
    <nav class="container mx-auto px-6 py-4">
        <div class="flex justify-between items-center">
            {{-- Logo & Brand --}}
            <a href="{{ route('filament.adminadmin.pages.halaman-utama') }}" class="flex items-center space-x-3 group">
                <div class="relative">
            ...
            <div class="hidden md:flex items-center space-x-6">
                <a href="{{ route('filament.adminadmin.pages.halaman-utama') }}" class="text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 font-medium transition-colors">
                    Beranda
                </a>
                @auth
                    <a href="{{ route('filament.adminadmin.pages.dashboard') }}" class="text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 font-medium transition-colors">
                        Dashboard
                    </a>
                @endauth
            </div>
            ...
            <div class="flex items-center space-x-4">
                @guest
                    <a href="{{ route('filament.adminadmin.auth.login') }}" class="px-5 py-2.5 text-sm font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-700 focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 transition-all">
                        Login
                    </a>
                    <a href="{{ route('filament.adminadmin.auth.register') }}" class="px-5 py-2.5 text-sm font-medium text-gray-700 bg-gray-100 rounded-lg hover:bg-gray-200 dark:text-gray-300 dark:bg-gray-700 dark:hover:bg-gray-600 transition-all">
                        Daftar
                    </a>
                @endguest
